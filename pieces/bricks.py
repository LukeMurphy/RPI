...
def main(run = True) :
	...
	config.brightnessFactorDark = float(workConfig.get("bricks", 'brightnessFactorDark'))
	config.brightnessFactorLight = float(workConfig.get("bricks", 'brightnessFactorLight'))
