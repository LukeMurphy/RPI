...
parser.add_argument('-brightnessOverride', type=int,
    ...
    if(reloading == False):
        try:
            ...
            if(args.cfg != None):
                ...
                print("Loading " + config.path + '/configs/pieces/' +
                      config.WRKINID + ".cfg" + " to run.")
                workconfig.read(
                    config.path + '/configs/pieces/' + config.WRKINID + ".cfg")
