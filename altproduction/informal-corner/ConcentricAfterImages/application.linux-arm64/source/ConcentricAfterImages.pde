...
void setup() {
	...
	// CORNER ROUND SQUARE
		if (setupSet == 2) {
			PsychShader.set("rTimeMult",5.02);
			PsychShader.set("gTimeMult",5.0);
			PsychShader.set("bTimeMult",2.010);

			// This affects the tone but adding to or dropping
			// each rgb chanel
			PsychShader.set("rFactor", 1.10);
			PsychShader.set("gFactor", 1.0);
			PsychShader.set("bFactor", 1.0);


			PsychShader.set("rMin", .010);
			PsychShader.set("gMin", .05);
			PsychShader.set("bMin", .01);

			PsychShader.set("distortionScale", .2);
			PsychShader.set("brightness", .75);
			PsychShader.set("tTimeMult", 1000.0);
			PsychShader.set("shaderFunction", 0);
