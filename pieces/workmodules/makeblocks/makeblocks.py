...
def makeComposition():
	...
	if random.random() < config.redrawProbablility :
		...
		bodyWidth = quadBlocks["body"]["proportions"][0] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)
		bodyLength = quadBlocks["body"]["proportions"][1] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)

		tailWidth = quadBlocks["tail"]["proportions"][0] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)
		tailLength = quadBlocks["tail"]["proportions"][1] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)

		headWidth = quadBlocks["head"]["proportions"][0] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)
		headLength = quadBlocks["head"]["proportions"][1] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)

		legWidth = quadBlocks["l1"]["proportions"][0] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)
		legLength = quadBlocks["l1"]["proportions"][1] * blockWidth * random.uniform(sizeVarianceMin,sizeVarianceMax)

		xOffsetVal = random.uniform(.1,2)

		quad = "l1"
		x1 = xStart * xOffsetVal
		y1 = yStart * random.uniform(.9,2.8)
