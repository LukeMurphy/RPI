...
def proc1(**kwargs):
	while True:
		...
		draw1.rectangle( (0, 0, round(random.uniform(10,100)), round(random.uniform(10,200) )), fill = 'green')
		time.sleep(.2)
...
def proc2(**kwargs):
	while True:
		...
		draw2.rectangle( (100, 0, 100 + round(random.uniform(10,100)), round(random.uniform(10,200) )), fill = 'yellow')
		time.sleep(.02)
