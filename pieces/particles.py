    ...
    if ps.objColor == "alphaRandom":
        ...
        if config.pUseHSV == True:
            p.fillColor = colorutils.getRandomColorHSV(
                config.pFillRange[0], config.pFillRange[1], config.pFillRange[2], config.pFillRange[3], config.pFillRange[4], config.pFillRange[5], 0, 0, int(config.pFillRange[6]))
            p.outlineColor = colorutils.getRandomColorHSV(config.pOutlineRange[0], config.pOutlineRange[1], config.pOutlineRange[
                                                          2], config.pOutlineRange[3], config.pOutlineRange[4], config.pOutlineRange[5], 0, 0, int(config.pOutlineRange[6]))
