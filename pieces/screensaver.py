...
def main(run=True):
    ...
    path = f"{config.path}/assets/imgs/"
    ...
    config.font1 = ImageFont.truetype(f"{config.path}/assets/fonts/freefont/FreeSerifBold.ttf", config.fontSize)
    config.font2 = ImageFont.truetype(
        f"{config.path}/assets/fonts/freefont/ComicSansMSBold.ttf",
        config.fontSize,
    )
    config.font3 = ImageFont.truetype(f"{config.path}/assets/fonts/freefont/FreeSansBold.ttf", config.fontSize)
